...
$liketag = "%".$tag."%";
	...
	$search_query = $db->prepare("SELECT *  FROM project natural join user  where tags like ?");
    $search_query->bind_param("s",$liketag);
...
if($search_result){
 ...
 //    	echo "Error: " . $sql . "<br>" . mysqli_error($db);
	// 	}
      ...
      $insert_tag->bind_param("iss", $uid, $tag, $currenttime);
      $insert_tag->execute();	
